...
parser.add_argument("--smooth", default=0.0, type=float, help="Temporal smoothing of keypoints (0=off, 0.5=medium, 0.8=heavy). Reduces avatar/camera jitter.")
parser.add_argument("--input-smooth", default=0.0, type=float, help="Blend camera frame with previous (0=off, 0.2-0.4=reduces noise).")
